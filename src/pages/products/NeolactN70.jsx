        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6">
              NeoLact <span className="text-blue-300">N70</span>
            </h1>
            ...
            >
              ...
              <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl shadow-xl p-4 max-w-[200px] border border-gray-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-slate-800 text-sm">Optimal Growth</p>
                    <p className="text-xs text-gray-500">Neuro-cognitive support</p>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl shadow-xl p-4 max-w-[200px] border border-gray-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">Lyophilised Technology</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="inline-flex items-center gap-3 bg-white px-4 py-2 rounded-full mb-4 shadow-sm border border-gray-200">
                ...
                <span className="text-slate-700 font-semibold text-xs uppercase tracking-wider">Product Description</span>
              </div>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-4">
              ...
              <div className="space-y-4">
                <p className="text-gray-600 leading-relaxed">
                  Each NeoLact 70 sachet is packed with <strong className="text-slate-800">1.55 g of high-quality human milk</strong>, 
                  ready to be reconstituted with boiled and cooled drinking water.
                </p>
                
                <p className="text-gray-600 leading-relaxed">
                  NeoLact 70 is specially formulated to deliver a minimum of <strong className="text-slate-800">70 kcal/100 ml</strong>, 
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              <div className="inline-flex items-center gap-3 bg-white px-4 py-2 rounded-full mb-4 shadow-sm border border-gray-200">
                ...
                <span className="text-slate-700 font-semibold text-xs uppercase tracking-wider">Mixing Guidelines</span>
              </div>
              <h3 className="text-2xl font-bold text-slate-800 mb-4">How to Prepare NeoLact N70</h3>
            ...
            >
              <div className="inline-flex items-center gap-3 bg-white px-4 py-2 rounded-full mb-4 shadow-sm border border-gray-200">
                ...
                <span className="text-slate-700 font-semibold text-xs uppercase tracking-wider">Key Benefits</span>
              </div>
              <h3 className="text-2xl font-bold text-slate-800 mb-6">Why Choose NeoLact N70?</h3>
              
              <div className="space-y-4">
                {benefits.map((benefit, index) => (
                  <div key={index} className="flex items-start gap-3 group p-3 rounded-xl hover:bg-gray-50 transition-all duration-300">
              ...
              {/* Shelf Stable Badge */}
              <div className="mt-6 bg-gradient-to-r from-slate-100 to-white rounded-2xl p-4 border border-gray-200">
                <div className="flex items-center gap-3">
