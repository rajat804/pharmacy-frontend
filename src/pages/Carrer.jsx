...
const Career = () => {
  ...
  const perks = [
    { title: "Competitive Salary", icon: <FaTrophy />, color: "from-yellow-500 to-yellow-400" },
    { title: "Health Insurance", icon: <FaHeartbeat />, color: "from-red-500 to-red-400" },
    { title: "Learning & Development", icon: <FaGraduationCap />, color: "from-blue-500 to-blue-400" },
    { title: "Flexible Work Hours", icon: <FaClock />, color: "from-green-500 to-green-400" }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-6xl font-bold mb-4">
              Build Your <span className="text-blue-300">Career</span> with Us
            </h1>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h2 className="text-3xl font-bold text-slate-800 mb-2">Why Work With Us?</h2>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-white px-6 py-2 rounded-full mb-4 shadow-sm border border-gray-200">
              ...
              <span className="text-slate-700 font-semibold text-sm uppercase tracking-wider">Open Positions</span>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            <h2 className="text-3xl font-bold text-slate-800 mb-2">Submit Your Application</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-600 to-blue-400 mx-auto rounded-full"></div>
          ...
          >
            {submitted ? (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-green-700">Application Submitted!</h3>
                <p className="text-green-600 mt-2">Thank you for your interest. Our HR team will review your application and contact you soon.</p>
              </motion.div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid md:grid-cols-2 gap-5">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-1">Position Applying For *</label>
                    <div className="relative">
