    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6">
              Awards & <span className="text-blue-300">Recognitions</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-white px-6 py-2 rounded-full mb-4 shadow-sm border border-gray-200">
              <FaTrophy className="text-slate-600 text-lg" />
              <span className="text-slate-700 font-semibold text-sm uppercase tracking-wider">Major Awards</span>
            </div>
                ...
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-3 flex items-center gap-2">
                      <span className="text-xs bg-gradient-to-r from-slate-600 to-slate-500 text-white px-2 py-1 rounded-full">
                        {award.impact}
                      </span>
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-white px-6 py-2 rounded-full mb-4 shadow-sm border border-gray-200">
              ...
              <span className="text-slate-700 font-semibold text-sm uppercase tracking-wider">Industry Recognitions</span>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {recognitions.map((recognition, index) => (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                viewport={{ once: true }}
                className="group bg-white rounded-2xl p-6 text-center shadow-sm hover:shadow-xl transition-all duration-500 border border-gray-100 hover:-translate-y-2 hover:border-blue-200"
              >
                <div className="w-16 h-16 bg-gradient-to-br from-slate-600 to-slate-500 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-md">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-white px-6 py-2 rounded-full mb-4 shadow-sm border border-gray-200">
              <FaCertificate className="text-blue-500 text-lg" />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {certifications.map((cert, index) => (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                viewport={{ once: true }}
                className="group bg-gradient-to-br from-gray-50 to-white rounded-2xl p-6 text-center shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2 border border-gray-100 hover:border-blue-200"
              >
                <div className="w-14 h-14 bg-gradient-to-br from-slate-600 to-slate-500 rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform shadow-md">
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-4xl font-bold text-slate-800 mb-4">Our Journey of Excellence</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-600 to-slate-400 mx-auto rounded-full"></div>
              ...
              {milestones.map((milestone, index) => (
                ...
                >
                  <div className="flex-1 md:text-right">
                    <div className="bg-white rounded-2xl p-4 hover:shadow-lg transition-all duration-300 group border border-gray-100">
                      <p className="text-sm text-blue-600 font-semibold mb-1">{milestone.year}</p>
                      <p className="text-sm text-slate-600 group-hover:text-slate-800 transition-colors">{milestone.achievement}</p>
                    </div>
                  </div>
                  
                  <div className="w-12 h-12 bg-gradient-to-br from-slate-600 to-slate-500 rounded-full flex items-center justify-center z-10 shadow-md border-2 border-white">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            {[
              { value: "12+", label: "National Awards", icon: <FaTrophy />, color: "from-slate-600 to-slate-500" },
              { value: "8+", label: "International Recognitions", icon: <FaGlobeAsia />, color: "from-blue-600 to-blue-500" },
              { value: "4", label: "Major Certifications", icon: <FaCertificate />, color: "from-slate-600 to-slate-500" },
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            ...
            <div className="mt-6 flex items-center justify-center gap-2">
              ...
              <span className="text-blue-300 font-semibold">Our Gratitude</span>
              <div className="w-12 h-0.5 bg-blue-300"></div>
            </div>
          </motion.div>
        </div>
