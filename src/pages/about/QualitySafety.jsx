...
const QualitySafety = () => {
  ...
  const qualityChecks = [
    { parameter: "Microbiological Safety", standard: "Zero Pathogens", status: "100% Compliant", icon: <FaMicroscope />, color: "from-blue-600 to-blue-500" },
    { parameter: "Nutritional Value", standard: "ISO Standards", status: "Verified", icon: <FaTint />, color: "from-blue-500 to-blue-400" },
    { parameter: "Chemical Residue", standard: "Below Detection Limits", status: "Clean", icon: <FaVial />, color: "from-blue-600 to-blue-500" },
    { parameter: "Temperature Control", standard: "-20°C to -80°C", status: "Maintained", icon: <FaTemperatureHigh />, color: "from-blue-500 to-blue-400" }
  ];
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6">
              Quality & <span className="text-blue-200">Safety</span>
            </h1>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            {certifications.map((cert, index) => (
              ...
              >
                ...
                <div className="absolute top-0 right-0 bg-gradient-to-br from-blue-600 to-blue-500 text-white px-3 py-1 rounded-bl-2xl text-sm font-semibold">
                  {cert.year}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-white px-6 py-2 rounded-full mb-4 shadow-sm border border-blue-100">
              ...
              <span className="text-blue-700 font-semibold text-sm uppercase tracking-wider">Safety Protocols</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
            ...
            {safetyProtocols.map((protocol, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="w-14 h-14 bg-gradient-to-br from-blue-600 to-blue-500 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform flex-shrink-0 shadow-md">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {protocol.steps.map((step, stepIdx) => (
                        <span key={stepIdx} className="text-xs bg-blue-50 text-blue-600 px-2 py-1 rounded-full border border-blue-100 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">
                          {step}
                        </span>
                      ))}
                    </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {qualityChecks.map((check, index) => (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                viewport={{ once: true }}
                className="group text-center bg-gradient-to-br from-white to-blue-50/30 rounded-2xl p-6 shadow-sm hover:shadow-xl hover:shadow-blue-200/50 transition-all duration-500 hover:-translate-y-2 border border-gray-100"
              >
                ...
                <h3 className="font-bold text-gray-800 mb-2 group-hover:text-blue-600 transition-colors">{check.parameter}</h3>
                <p className="text-xs text-gray-500 mb-2">{check.standard}</p>
                <span className="inline-block text-sm text-blue-600 font-semibold bg-blue-50 px-3 py-1 rounded-full border border-blue-100 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">
                  {check.status}
                </span>
              </motion.div>
            ))}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {facilities.map((facility, index) => (
              ...
              >
                ...
                <h3 className="text-lg font-bold mb-2 group-hover:text-blue-200 transition-colors">{facility.name}</h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="bg-gradient-to-r from-blue-50/50 to-white rounded-3xl p-8 md:p-10 text-center border border-blue-100 shadow-sm hover:shadow-xl hover:shadow-blue-200/30 transition-all duration-300"
          >
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            {[
              ...
              { value: "24/7", label: "Monitoring", icon: <FaTemperatureHigh />, color: "from-blue-500 to-blue-400" },
              { value: "0", label: "Safety Incidents", icon: <FaShieldAlt />, color: "from-blue-600 to-blue-500" },
              { value: "500+", label: "Daily Tests", icon: <FaMicroscope />, color: "from-blue-500 to-blue-400" }
            ].map((stat, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, scale: 0.9 }}
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Learn More About Our <span className="text-blue-600">Quality Standards</span>
            </h2>
