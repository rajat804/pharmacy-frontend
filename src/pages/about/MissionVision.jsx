...
const MissionVision = () => {
  ...
  const goals = [
    ...
    { year: "2026", title: "Launch 3 New Products", progress: 40, icon: <FaRocket />, color: "from-blue-500 to-blue-400" },
    { year: "2027", title: "Impact 1,00,000+ Babies", progress: 25, icon: <FaBaby />, color: "from-blue-600 to-blue-500" },
    { year: "2028", title: "International Expansion", progress: 10, icon: <FaGlobeAsia />, color: "from-blue-500 to-blue-400" }
  ];
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6">
              Mission & <span className="text-blue-200">Vision</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-blue-50 px-6 py-2 rounded-full mb-4 shadow-sm border border-blue-100">
              ...
              <span className="text-blue-700 font-semibold text-sm uppercase tracking-wider">Our Mission</span>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {missionPoints.map((point, index) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-blue-600 to-blue-400 rounded-b-2xl transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-20 bg-gradient-to-b from-blue-50/20 to-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {visionPoints.map((point, index) => (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                viewport={{ once: true }}
                className="group bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-2xl hover:shadow-blue-200/50 transition-all duration-500 hover:-translate-y-3 border border-gray-100"
              >
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="bg-gradient-to-br from-blue-800 to-blue-700 rounded-3xl p-8 md:p-10 text-center text-white shadow-xl hover:shadow-2xl transition-all duration-300"
          >
            ...
            <div className="mt-6 flex items-center justify-center gap-2">
              ...
              <span className="text-blue-200 font-semibold">Our North Star</span>
              <div className="w-12 h-0.5 bg-blue-200"></div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Strategic Goals</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-600 to-blue-400 mx-auto rounded-full"></div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {goals.map((goal, index) => (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                viewport={{ once: true }}
                className="group bg-gradient-to-br from-white to-blue-50/30 rounded-2xl p-6 shadow-sm hover:shadow-xl hover:shadow-blue-200/50 transition-all duration-500 hover:-translate-y-2 border border-gray-100"
              >
      ...
      <section className="py-20 bg-gradient-to-b from-blue-50/20 to-white">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Our Core Commitments</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-600 to-blue-400 mx-auto rounded-full"></div>
            <p className="text-gray-500 max-w-2xl mx-auto mt-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                viewport={{ once: true }}
                className="text-center group bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl hover:shadow-blue-200/50 transition-all duration-500 hover:-translate-y-2 border border-gray-100"
              >
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            {[
              ...
              { value: "500+", label: "Hospital Partners", icon: <FaHospitalUser />, color: "from-blue-500 to-blue-400" },
              { value: "100%", label: "Human Milk Products", icon: <FaHeartbeat />, color: "from-blue-600 to-blue-500" },
              { value: "12+", label: "Research Publications", icon: <FaAward />, color: "from-blue-500 to-blue-400" }
            ].map((stat, index) => (
              <motion.div
                key={index}
