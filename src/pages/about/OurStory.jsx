        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6">
              Every Drop Tells a <span className="text-blue-300">Story</span>
            </h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-3 bg-white px-4 py-2 rounded-full mb-4 shadow-sm border border-gray-200">
                ...
                <span className="text-slate-700 font-semibold text-xs uppercase tracking-wider">The Beginning</span>
              </div>
              ...
              <div className="flex items-center gap-4 mt-6">
                <div className="flex -space-x-2">
                  <div className="w-10 h-10 bg-gradient-to-br from-blue-600 to-blue-500 rounded-full flex items-center justify-center text-white text-xs font-bold shadow-md">50K+</div>
                  <div className="w-10 h-10 bg-gradient-to-br from-slate-600 to-slate-500 rounded-full flex items-center justify-center text-white text-xs font-bold shadow-md">500+</div>
                  <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-400 rounded-full flex items-center justify-center text-white text-xs font-bold shadow-md">100+</div>
                </div>
            ...
            >
              ...
              <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl shadow-xl p-4 max-w-[220px] border border-gray-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-slate-800 text-sm">Every baby deserves</p>
                    <p className="text-xs text-gray-500">the best nutrition</p>
                  </div>
                </div>
              </div>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-8">
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white rounded-3xl p-8 shadow-md hover:shadow-2xl transition-all duration-500 group border border-gray-100 hover:-translate-y-2"
            >
              ...
              <h3 className="text-2xl font-bold text-slate-800 mb-3 group-hover:text-blue-600 transition-colors">Our Mission</h3>
            ...
            <motion.div
              ...
              className="bg-white rounded-3xl p-8 shadow-md hover:shadow-2xl transition-all duration-500 group border border-gray-100 hover:-translate-y-2"
            >
              <div className="w-16 h-16 bg-gradient-to-br from-slate-600 to-slate-500 rounded-2xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform shadow-md">
                <FaGlobeAsia className="text-white text-2xl" />
              </div>
              <h3 className="text-2xl font-bold text-slate-800 mb-3 group-hover:text-blue-600 transition-colors">Our Vision</h3>
              <p className="text-gray-500 leading-relaxed">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-blue-600 to-slate-400 mx-auto rounded-full mb-4"></div>
          ...
          <div className="relative">
            {/* Timeline Line */}
            <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-blue-400 via-slate-400 to-blue-400 hidden md:block"></div>
            ...
            {milestones.map((milestone, index) => (
              ...
              >
                <div className="flex-1 md:pr-8 md:text-right">
                  <div className="bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-500 border border-gray-100 group hover:-translate-y-1">
                ...
                <div className="w-12 h-12 bg-gradient-to-br from-blue-600 to-slate-500 rounded-full flex items-center justify-center text-white font-bold z-10 shadow-lg my-4 md:my-0">
                  {index + 1}
                </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                viewport={{ once: true }}
                className="bg-white rounded-2xl p-6 text-center shadow-md hover:shadow-2xl transition-all duration-500 group border border-gray-100 hover:-translate-y-2"
              >
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-4xl font-bold text-slate-800 mb-4">Leadership Team</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-600 to-slate-400 mx-auto rounded-full mb-4"></div>
            <p className="text-gray-500 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {teamMembers.map((member, index) => (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                viewport={{ once: true }}
                className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-6 text-center shadow-md hover:shadow-2xl transition-all duration-500 group hover:-translate-y-2 border border-gray-100"
              >
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <motion.div
              ...
              className="p-6"
            >
              <div className="text-5xl font-bold text-blue-300 mb-2">50,000+</div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            {[
              ...
              { value: "100%", label: "Quality Commitment", icon: <FaStar />, color: "from-slate-600 to-slate-500" },
              { value: "24/7", label: "Support Available", icon: <FaHeart />, color: "from-blue-500 to-blue-400" },
              { value: "12+", label: "Research Publications", icon: <FaChartLine />, color: "from-slate-500 to-slate-400" }
            ].map((stat, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, scale: 0.9 }}
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-gray-500 mb-8 leading-relaxed">
              Whether you're a healthcare professional, a potential donor, or a parent seeking the best 
              for your baby, we're here to support you every step of the way.
            </p>
